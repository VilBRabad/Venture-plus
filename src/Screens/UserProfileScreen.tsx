import { StyleSheet, Text, ScrollView, View, Dimensions, Pressable, Image, ActivityIndicator, TouchableOpacity } from 'react-native'
...
export default function UserProfileScreen() {
    ...
    return (
        <>
            ...
            >
                <MaterialIcons name='feedback' size={23} color="#FFFFFF" />
            </TouchableOpacity>
        </>
    )
}
